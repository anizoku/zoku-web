...
export default function BannersPanel() {
  ...
  const invalidate = () => queryClient.invalidateQueries({ queryKey: ["platform-banners-admin"] });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-space font-bold text-xl text-foreground">Banners da Plataforma</h2>
      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-4">
        <h3 className="text-sm font-semibold text-foreground">Adicionar banner</h3>
        <ImageUploadField
